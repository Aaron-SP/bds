...
static constexpr float _s_bg_menu_ext_x = _s_bg_menu_x * 0.5;
static constexpr float _s_bg_menu_ext_x_2 = _s_bg_menu_ext_x * 0.5;
static constexpr float _s_fg_menu_y = _s_fg;
static constexpr float _s_fg_menu_x = _s_bg_menu_x - (_s_bg - _s_fg);
static constexpr float _s_fg_menu_ext_x = (_s_bg_menu_x * 0.5) - (_s_bg - _s_fg);
...
static constexpr float _menu_ext_dx = -312.0;
...
static constexpr float _menu_x_space = _s_bg_menu_x + 8.0;
static constexpr float _menu_ext_x_space = _s_bg_menu_ext_x + 8.0;
static constexpr float _menu_y_space = _s_bg_menu_y + 8.0;
