...
class ui_bg_assets
{
  ...
  public:
...

    {
        ...
        static_assert(transparent_start() == 0, "Value does not match expected value");
        static_assert(transparent_size() == 5, "Value does not match expected value");
        static_assert(opaque_start() == 5, "Value does not match expected value");
        static_assert(opaque_base_size() == 36, "Value does not match expected value");
        static_assert(menu_splash_start() == 9, "Value does not match expected value");
        static_assert(menu_splash_size() == 1, "Value does not match expected value");
        static_assert(menu_start() == 10, "Value does not match expected value");
        static_assert(menu_size() == 10, "Value does not match expected value");
        static_assert(opaque_ext_size() == 109, "Value does not match expected value");
        static_assert(focus_start() == 5 + 109, "Value does not match expected value");
        static_assert(focus_size() == 1, "Value does not match expected value");
        static_assert(focus_bar_size() == 2, "Value does not match expected value");
        static_assert(tooltip_start() == 5 + 109 + 2, "Value does not match expected value");
        static_assert(tooltip_size() == 1, "Value does not match expected value");
        static_assert(max_size() == 117, "Value does not match expected value");
    }
    inline void reset()
    {
        _energy = 0.0;
